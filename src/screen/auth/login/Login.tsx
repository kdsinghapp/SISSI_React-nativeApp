...
const styles = StyleSheet.create({
  ...
  logo: { height: 80, width: 80, alignSelf: 'center', marginVertical:20 },
  title: { fontSize: 28, fontWeight: '600', color: color.textPrimary, textAlign: 'center' },
  subtitle: { fontSize: 15, color: color.textPrimary, textAlign: 'center', marginTop: 5 },
  inputContainer: { marginTop: 20, marginHorizontal: 15 },
  errorText: { color: 'red', fontSize: 12, marginTop: 5 },
  forgotText: { textAlign: 'center', color: color.textPrimary, fontSize: 14, marginTop: 15 },
